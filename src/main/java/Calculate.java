...
public class Calculate {
    ...
    JSONArray docList;
    long timestamp;
    public Calculate(JSONArray cond_array, JSONArray docList, long timestamp){
...
//            jsonObject1.put("kpi",k+".count");
//            jsonObject1.put("timestamp",timestamp);
//            jsonObject1.put("value",map.get(k).all);
//            jsonObject1.put("interval",10);
